...
_spec = importlib.util.spec_from_file_location("v325_corrected_coskew_source", SOURCE)
...
def failure_outputs(root: Path, gate: dict[str, Any], records: list[dict[str, Any]]) -> None:
    ...
    (results / "REPORT_RU.md").write_text(
        "# Active V333–V340 — exact coskewness beta hedge\n\n"
...
def run(root: Path, cache: Path) -> int:
    ...
    gate = {**gate, "candidate": "V333_FIXED_UNIVERSE_DATA_COVERAGE"}
    ...
    proof = {
        ...
        "source_cycle": "V325-V332",
        "corrected_coskewness_moment": True,
        "hedge_specification_source": "V317-V324 preregistration",
        "source_materialization_provenance": 'origin/agent/active-v317-v324-coskew-beta-hedge:research/active_v317_v324/run_research.py',
        ...
        "coverage_gate": gate,
        "design_sha256": sha256_file(root / "V333_V340_DESIGN.json"),
