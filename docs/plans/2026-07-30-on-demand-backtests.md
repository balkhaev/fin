...
> Статус 2026-07-30: первоначальный preflight для Atlas/Funding/Consensus
> заменён полноценными replay-движками. Актуальный контракт, границы доказательств
> и измеренные результаты описаны в
> `docs/plans/2026-07-30-all-strategy-factor-backtests.md`.
