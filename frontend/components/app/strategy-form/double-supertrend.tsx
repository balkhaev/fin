...
export function DoubleSupertrend({ control }: Props) {
  return (
    <div className="space-y-6">
      ...
      <div className="space-y-4">
        <h3 className="text-lg font-semibold">Global Trend Configuration</h3>
        <div className="grid grid-cols-2 gap-4">
          <FormField
            control={control}
            name="global.period"
      ...
      <div className="space-y-4">
        <h3 className="text-lg font-semibold">Realtime Trend Configuration</h3>
        <div className="grid grid-cols-2 gap-4">
          <FormField
            control={control}
